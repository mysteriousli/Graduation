package com.ligy.core;


import com.ligy.core.enums.ExecutionStatusEnum;
...
public class Constants {
    ...
    public static final String SCHEDULERTOKEN = "schedulerToken";
    ...
    public static final Integer IS_DIMENSION_NOT = 1;
    public static final String SQL_DOT = ".";
    public static final String DEFAULT_FILE_PATH_PARAM = "${FILE_DAY}";
    public static final String DEFAULT_FILE_PATH_PARAM_NAME = "FILE_DAY";
    ...
    public static final String ORG_QUARTZ_SCHEDULER_MAKESCHEDULERTHREADDAEMON
    ...
    public static final String ORG_QUARTZ_JOBSTORE_CLUSTERCHECKININTERVAL
    ...
    public static final String ORG_QUARTZ_DATASOURCE_MYDS_CONNECTIONPROVIDER_CLASS
     ...
     */
    public static final String COMMON_PROPERTIES_PATH = "/runner.properties";

    /**
     * common properties path.
     */
    public static final String ENV_PROPERTIES_PATH = "/env.properties";
     ...
     */
    public static final String ZOOKEEPER_DOLPHINSCHEDULER_LOCK_FAILOVER_STARTUP_MASTERS
     ...
     * QUEWTON_MARK "\\?" .
     */
    public static final String QUEWTON_MARK="\\?";
    /**
     * SEMICOLON ;.
     */
    ...
    public static final Pattern REGEX_MAIL_NAME
            = Pattern.compile("^([a-z0-9A-Z]+[_|\\-|\\.]?)+[a-z0-9A-Z]@([a-z0-9A-Z]"
            + "+(-[a-z0-9A-Z]+)?\\.)+[a-zA-Z]{2,}$");
    ...
    public static final String SPRING_DATASOURCE_TIME_BETWEEN_EVICTION_RUNS_MILLIS
            = "spring.datasource.timeBetweenEvictionRunsMillis";

    public static final String SPRING_DATASOURCE_TIME_BETWEEN_CONNECT_ERROR_MILLIS
            = "spring.datasource.timeBetweenConnectErrorMillis";

    public static final String SPRING_DATASOURCE_MIN_EVICTABLE_IDLE_TIME_MILLIS
    ...
    public static final String SPRING_DATASOURCE_MAX_POOL_PREPARED_STATEMENT_PER_CONNECTION_SIZE
    ...
    public static final int EXIT_CODE_CANCELED = 2;

    /**
     * exit code kill.
     */
    public static final int EXIT_CODE_KILL = 2;
    ...
    public static final String WELL_STRING  = "#";
    ...
    public static final int[] NOT_TERMINATED_STATES = new int[] {
            ExecutionStatusEnum.SUBMITTED_SUCCESS.ordinal(),
            ExecutionStatusEnum.RUNNING_EXECUTION.ordinal(),
            ExecutionStatusEnum.DELAY_EXECUTION.ordinal(),
            ExecutionStatusEnum.READY_PAUSE.ordinal(),
            ExecutionStatusEnum.READY_STOP.ordinal(),
            ExecutionStatusEnum.NEED_FAULT_TOLERANCE.ordinal(),
            ExecutionStatusEnum.WAITING_THREAD.ordinal(),
            ExecutionStatusEnum.WAITING_DEPEND.ordinal()
    };
    ...
    public static final String COM_GBASE_JDBC_DRIVER = "com.gbase.jdbc.Driver";
    ...
    public static final String COM_ALIYUN_ODPS_JDBC_ODPS_DRIVER = "com.aliyun.odps.jdbc.OdpsDriver";

    public static final String JDBC_MAXCOMPUTE = "jdbc:odps:";
    ...
    public static final String GBASE_VALIDATION_QUERY = "select 1";
    ...
    public static final String MAXCOMPUTE_VALIDTION_QUERY = "select 1";
    public static final String DETECTION_SQL_QUERY = "select ";
    public static final String DETECTION_SQL_NAME = " VAL  " ;
    public static final String DETECTION_SQL_FROM = " from  " ;
    public static final String DETECTION_SQL_DB = " tb " ;
    public static final String DETECTION_SQL_AS = " AS " ;
    /**
     * database type.
     */
    ...
    /**
     * ExternalCheckTaskService  jdbc url .
     */
    public static final String EXTERNAL_CHECK_JDBC_MYSQL = "jdbc:mysql";
    public static final String EXTERNAL_CHECK_JDBC_POSTGRESQL = "jdbc:postgresql";
    public static final String EXTERNAL_CHECK_JDBC_HIVE_2 = "jdbc:hive2";
    public static final String EXTERNAL_CHECK_JDBC_CLICKHOUSE = "jdbc:clickhouse";
    public static final String EXTERNAL_CHECK_JDBC_ORACLE = "jdbc:oracle";
    public static final String EXTERNAL_CHECK_JDBC_SQLSERVER = "jdbc:sqlserver";
    public static final String EXTERNAL_CHECK_JDBC_DB2 = "jdbc:db2";
    public static final String EXTERNAL_CHECK_JDBC_PRESTO = "jdbc:presto";
    public static final String EXTERNAL_CHECK_JDBC_TRINO = "jdbc:trino";
     ...
     * @date: 2021/2/2
     */
    public static final String TASKINSTANCEMDC = "taskInstanceId";

    public static final String DATASYNCTASKTYPE = "FLINKX";

    public static final String DATASYNCINSTANCETYPE = "DATASYNC";

    public static final String SQL_TASK = "SQL";

    public static final  String OFFLINESERVICETASKTYPE = "FLINKX";

    public static final  String OFFLINESERVICEINSTANCETYPE = "OFFLINESERVICE";

    public static final  String SHELLTASKTYPE = "SHELL";

    /**
     * 标准信息项检测运行实例类型.
     */
    public static final String STANDARD_INFO_ITEM_RUN_INSTANT_CYCLE = "cycle";
    public static final String STANDARD_INFO_ITEM_RUN_INSTANT_MANUAL = "manual";

    /**
     * API服务参数类型.
     */
    public static final String API_PARAM_TYPE_IN = "IN";
    public static final String API_PARAM_TYPE_OUT = "OUT";

    /**
     * 质量检测，对比方式
     */
    public static final String DETECTION_DETERMINE_SYMBOL_BIG = ">" ;
    public static final String DETECTION_DETERMINE_SYMBOL_SMALL = "<" ;
    public static final String DETECTION_DETERMINE_SYMBOL_EQUAL = "=" ;
    public static final String DETECTION_DETERMINE_SYMBOL_VARY = "!=" ;
    public static final String DETECTION_DETERMINE_SYMBOL_BIG_OR_EQUAL = ">=" ;
    public static final String DETECTION_DETERMINE_SYMBOL_SMALL_OR_EQUAL = "<=" ;
    /**
     * data dev .
     * @date: 2021/5/27
     */
    public static final String DATA_DEV_TREE_SCRIPT_NODE_NAME = "脚本管理";


    public static final String DEP_PROJECT_MANAGER = "DEP_PROJECT_MGR";
    public static final String DEP_BUSINESS_USER = "DEP_BUSINESS_USER";
    public static final String DEP_OPERATORS_USER = "DEP_OPERATORS_USER";

    /**
     * 元数据类型：数仓元数据.
     */
    public static final Integer META_DATA = 1;
    /**
     * 元数据类型：文件元数据.
     */
    public static final Integer FILE_META_DATA = 2;
    ...
    public  static  final  String DEP_INSIDE_AUTHENTICATION_KEY = "DEP_INSIDE_AUTH";


    public  static  final  String DEP_INSIDE_AUTHENTICATION_VAL = "8d687fcc-fc7b-496c-8107-6bb1451d9b87";

    /***
     * 未发布或已下线
     */
    public static final Integer MODEL_STATUS_PULISH_NOT = 0;
    /***
     * 已发布
     */
    public static final Integer MODEL_STATUS_PULISH_AL = 1;
    /***
     * 历史发布
     */
    public static final Integer MODEL_STATUS_PULISH_HIS = 2;

    public static final String SAVE_OR_PUBLISH_SAVE = "save";
    public static final Integer IS_MEASURE = 0;
    public static final Integer IS_MEASURE_NOT = 1;
    public static final Integer IS_USE_VER_NOT = 1;
    public static final Integer IS_USE_VER = 0;

    public static  final  String OPER_LOG_INDEX_NAME="oper_log";

    public static  final  String DEP_SYS_LOG_INDEX_NAME="dep_*";
     ...
     * registry properties
     */
    public static final String REGISTRY_DEP_RUNNER = "/nodes/runner";
    public static final String REGISTRY_DEP_DEAD_SERVERS = "/dead-servers";
    public static final String REGISTRY_DEP_NODE = "/nodes";
    public static final String REGISTRY_DEP_LOCK_RUNNER = "/lock/runner";
    public static final String REGISTRY_DEP_LOCK_FAILOVER_RUNNER = "/lock/failover/runner";
    public static final String REGISTRY_SERVERS = "registry.servers";

    public static  final  String DEFAULTDATABASE ="martDs";

    public static  final  String BATCH_OPERATION_SUCCESS ="batch_operation_success";

    public static  final  String BATCH_OPERATION_FAIL ="batch_operation_fail";
    public static final Integer IS_DIMENSION_IS = 0;

    public static final String SQL_TASK_RUN_RESULT_ES_INDEX = "dep_sql_task_query_result";

    public static final String DETECTION_TASK_RUN_RESULT_ES_INDEX = "dep_detection_query_result_index";

    public static final String ENCRYPT_KEY = "asZ9DLpQlpKtq0qL";
