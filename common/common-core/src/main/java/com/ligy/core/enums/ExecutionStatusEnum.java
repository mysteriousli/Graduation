...
public enum ExecutionStatusEnum {
    ...
    ExecutionStatusEnum(int code, String descp) {
        this.code = code;
        this.descp = descp;
    }
    ...
    private static HashMap<Integer, ExecutionStatusEnum> EXECUTION_STATUS_MAP = new HashMap<>();

    static {
        for (ExecutionStatusEnum executionStatus : ExecutionStatusEnum.values()) {
    ...
    public static ExecutionStatusEnum of(int status) {
